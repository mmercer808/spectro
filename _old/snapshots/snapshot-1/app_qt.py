"""
Engine Seed v3 - Qt/PySide6 Host

Qt-based demo for integration with desktop applications.
Same architecture as moderngl-window version, different host.
"""
...
class GLHost(QtOpenGLWidgets.QOpenGLWidget):
    """OpenGL widget that hosts the engine."""
    ...
    def initializeGL(self):
        """Initialize OpenGL context and engine systems."""
    ...
    def _setup_demo_viewports(self):
        ...
        # Right area: Single cube, X-axis spin, 4 cameras (quad view)
    ...
    def mousePressEvent(self, e):
        self._route_mouse(e, "press")
    
    def mouseReleaseEvent(self, e):
        self._route_mouse(e, "release")
    
    def mouseMoveEvent(self, e):
        self._route_mouse(e, "move")
...
def main():
    ...
    win.resize(1200, 720)
    win.setWindowTitle("Engine Seed v3 — Qt host")
    win.show()
