...
@dataclass
class Transform:
    pos: np.ndarray = np.array([0.0, 0.0, 0.0], dtype=np.float32)
    rot_euler: np.ndarray = np.array([0.0, 0.0, 0.0], dtype=np.float32)
    scale: np.ndarray = np.array([1.0, 1.0, 1.0], dtype=np.float32)
